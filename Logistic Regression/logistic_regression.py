...
2. You can use statsmodels through sm.Logit. Then, you can check out p values
   under column (P>|z|).
3. You can use PolynomialFeature to add column(s) of higher degree IV(s)
   making the problem a polynomial logistic regression problem.
'''